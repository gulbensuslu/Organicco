...
public class MarmaladeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_marmalade, container, false);
        recylerView = v.findViewById(R.id.recyclerViewMarmalade);
        FirebaseFirestore_database=FirebaseFirestore.getInstance();
        firebaseAuth= FirebaseAuth.getInstance();

        Query query_other= FirebaseFirestore_database.collection("Marmalade");
        FirestoreRecyclerOptions<Products> options =new FirestoreRecyclerOptions.Builder<Products>()
                .setQuery(query_other,Products.class)
                .build();


        firestoreRecyclerAdapter= new FirestoreRecyclerAdapter<Products, MarmaladeFragment.MViewHolder>(options) {
            @NonNull
            @Override
            public MarmaladeFragment.MViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.products_cardview, parent, false);

                return new MarmaladeFragment.MViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull MarmaladeFragment.MViewHolder holder, int position, @NonNull Products model) {
