...
public class MilkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recylerView=v.findViewById(R.id.recyclerViewMilk);
        FirebaseFirestore_database=FirebaseFirestore.getInstance();
        firebaseAuth=FirebaseAuth.getInstance();
        Query query= FirebaseFirestore_database.collection("MilkAndDairyProducts");
        FirestoreRecyclerOptions<Products> options =new FirestoreRecyclerOptions.Builder<Products>()
                .setQuery(query,Products.class)
                .build();
        firestoreRecyclerAdapter= new FirestoreRecyclerAdapter<Products, MilkFragment.MilkViewHolder>(options) {
            @NonNull
            @Override
            public MilkFragment.MilkViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull MilkFragment.MilkViewHolder holder, int position, @NonNull Products model) {
    ...
    private class MilkViewHolder extends RecyclerView.ViewHolder {
